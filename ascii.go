...
const AsciiEx = "\x80\x81\x82\x83\x84\x85\x86\x87\x88\x89\x8a\x8b\x8c\x8d\x8e" +
 ...
 // Ved å analysere utskriften for spesielt bytes fra 0x80 til 0x9F ser vi at i GoLand
 // Forstår programmet alle de forskjellige typene fra Hexadesimaler, desimaler og bytes
 // og klarer derfor å printe alle de forskjellige nødvendige formatene. Derimot i Terminalen
 // eller Powershell ser vi en endring i utskriften hvor alle gruppemedlemmers PCer får
 // vanskeligheter i å printe ut alle formatene fra 0x80 til 0x9F. Symbolene mangler.


func ExtendedASCIIText() {
  hexverdi := []byte{'\x22', '\x20', '\xe2', '\x82', '\xac', '\x20', '\xc3', '\xb7', '\x20', '\xc2', '\xbe', '\x20', '\x64', '\x6f', '\x6c', '\x6c', '\x61', '\x72', '\x20', '\x22'}
